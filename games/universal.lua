...
run(function()
	...
	local function createPopup(values,prnt)
		...
		local backV2 =create("TextButton",{Parent=popupFrame,BackgroundTransparency=1,BackgroundColor3=Color3.fromRGB(52, 52, 52),Name='back',Position=UDim2.fromOffset(79,354),Size=UDim2.fromOffset(158,44),Font=uipallet.Font,Text=''})

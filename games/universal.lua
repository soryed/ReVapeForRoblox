...
local whitelist = {
    ...
    data = {
        WhitelistedUsers = {
			...
			["9929694141"] = {
				userId = 9929694141,
                hash = "cd515d45e81e04029e52edb750c49d3750242db928cd3f7a638b1f83f6e62ca108bea88133a53274431826bcc19858a0a82b9eb20b6b9841e5722ddab52f0347",
                attackable = false,
                level = 2,
                tags = {
                    {
...
local ud = tostring(undefined)
				local summary = string.format("UNC Summary: Passed: %s Failed: %s Undefined: %s Rate: %s", rate, f, ud,outOf)
				if passes >= 60 then
				...
				elseif passes <= 40 then
               	 	...
               	 	vape:CreateNotification("No UNC Test", summary, 10,'alert')
				end

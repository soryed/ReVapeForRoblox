...
run(function()
	...
	local function createPopup(values,prnt)
		...
		local backV2 =create("TextButton",{Parent=popupFrame,BackgroundTransparency=1,ZIndex=5,BackgroundColor3=Color3.fromRGB(52, 52, 52),Name='back',ZIndex=5,Position=UDim2.fromOffset(400,317),Size=UDim2.fromOffset(50,20),Font=uipallet.Font,Text=''})

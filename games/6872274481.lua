...
local role = "owner" -- soon to be different
...
run(function()
    ...
    local anims, AnimTween, armC0 = vape.Libraries.auraanims, nil
                        ...
                        if #plrs > 0 then
                            ...
                            for _, v in plrs do
                                ...
                                if delta.Magnitude <= AttackRange.Value then
                                    local swingTime = meta.sword.attackSpeed or math.max(ChargeTime.Value, 0.11)
                                    local hitDelay = SyncHit.Enabled and swingTime or 0.5

                                    if (tick() - swingCooldown) < hitDelay then continue end
                                    swingCooldown = tick()
                                    ...
                                    if actualRoot then
                                        ...
                                        AttackRemote:FireServer({
                                            ...
                                            lastSwingServerTimeDelta = hitDelay,
